...
- `link <ISSUE-KEY> --to <ISSUE-KEY> [--relation <blocks|blocked-by|clones|is-cloned-by|duplicates|is-duplicated-by|relates-to>]` — create an issue link (default relation: `blocks`).
